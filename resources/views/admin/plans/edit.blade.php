...
<div class="w-full mx-auto">
    ...
    <div class="mb-12">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <h1 class="text-4xl font-bold text-white tracking-normal uppercase">Modify <span class="text-supabase-accent">Plan Matrix</span></h1>
    ...
    <form action="{{ route('admin.plans.update', $plan) }}" method="POST" class="space-y-8">
        ...
        <div class="flex items-center justify-end space-x-6 pt-8 border-t border-supabase-border">
            <a href="{{ route('admin.plans.index') }}" class="text-[10px] font-bold text-supabase-muted uppercase tracking-wider hover:text-white transition-colors">Discard Updates</a>
