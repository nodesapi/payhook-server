...
<div class="mb-12">
    <div class="flex items-center space-x-4">
        ...
        <div>
            <h1 class="text-4xl font-bold text-white tracking-normal uppercase">Add <span class="text-supabase-accent">Channel</span></h1>
        ...
        <div class="bg-supabase-surface border border-supabase-border rounded-3xl p-8 space-y-8 shadow-2xl">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <p class="text-[8px] text-supabase-muted uppercase font-bold tracking-normal">Must be unique, no spaces.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <div id="imagePreviewContainer" class="hidden mb-4 p-2 bg-white rounded-xl inline-block border border-supabase-border">
                        <img id="imagePreview" src="" alt="Preview" class="h-12 object-contain">
                    </div>
                    
                    <input type="file" name="logo" id="logoInput" accept="image/*" class="sb-input !p-2 bg-supabase-dark">
                    <p class="text-[8px] text-supabase-muted uppercase font-bold tracking-normal">Recommended: 200x200px PNG transparent.</p>
