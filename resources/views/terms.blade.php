                ...
                <div class="max-w-4xl mx-auto bg-supabase-surface border border-supabase-border rounded-[40px] p-8 md:p-16 shadow-2xl">
                    ...
                    <div class="space-y-8 text-sm text-slate-300 font-medium leading-relaxed">
                        <section class="space-y-4">
                            <h2 class="text-lg font-bold text-white uppercase tracking-wider">{{ __('1. Penerimaan Ketentuan') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-bold text-white uppercase tracking-wider">{{ __('2. Deskripsi Layanan') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-bold text-white uppercase tracking-wider">{{ __('3. Tanggung Jawab Akun & Perangkat') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-bold text-white uppercase tracking-wider">{{ __('4. Batasan Tanggung Jawab') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-bold text-white uppercase tracking-wider">{{ __('5. Penggunaan yang Diperbolehkan') }}</h2>
