...
@section('title', 'Add QRIS Template')

@section('content')
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold">Add QRIS Template</h1>
        <p class="text-gray-600 mt-2">Scan QR code Anda terlebih dahulu, lalu paste QRIS string di sini.</p>
        <a href="/qris-decoder.html" target="_blank" class="text-blue-600 underline">📷 Open QR Code Scanner →</a>
    </div>

    <form action="{{ route('qris-templates.store') }}" method="POST" class="bg-white rounded-lg border p-6">
        @csrf
        ...
        <div class="mb-4">
            ...
            <textarea name="qris_string" rows="8" 
                      ...
                      required>{{ old('qris_string') }}</textarea>
