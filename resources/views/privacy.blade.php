                ...
                <div class="max-w-4xl mx-auto bg-supabase-surface border border-supabase-border rounded-[40px] p-8 md:p-16 shadow-2xl">
                    ...
                    <div class="space-y-8 text-sm text-slate-300 font-medium leading-relaxed">
                        <section class="space-y-4">
                            <h2 class="text-lg font-black text-white uppercase tracking-wider">{{ __('1. Komitmen Privasi Cekbayar') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-black text-white uppercase tracking-wider">{{ __('2. Data yang Diproses') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-black text-white uppercase tracking-wider">{{ __('3. Penyimpanan Data') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-black text-white uppercase tracking-wider">{{ __('4. Keamanan Informasi') }}</h2>
                        ...
                        <section class="space-y-4">
                            <h2 class="text-lg font-black text-white uppercase tracking-wider">{{ __('5. Perubahan Kebijakan') }}</h2>
